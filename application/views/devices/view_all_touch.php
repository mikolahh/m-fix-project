<div class="row" style="width: 100%;">	
 ...
 <td><?php if ($lcd_sing_price == 0) {
	echo "звоните для уточнения";}
	else { echo $lcd_sing_repair;} ?></td>

 <td class="hidden-xs"><?php if ($lcd_sing_price == 0) {
	echo "звоните для уточнения";}
	else { echo $lcd_sing_repair_disc;} ?></td>
 ...
 <td><?php if ($touch_price == 0) {
	echo "звоните для уточнения";}
	else { echo $touch_repair;} ?></td>

 <td class="hidden-xs"><?php if ($touch_price == 0) {
	echo "звоните для уточнения";}
	else { echo $touch_repair_disc;} ?></td>
 <td class="hidden-xs"><?php echo "можно быстрее, но лучше 1-сутки "; ?></td>
 <td class="hidden-xs"><?php echo "4 месяца"; ?></td>
 
 </tr>
 <tr>
 <td><h2 style="font-size: 1.15em; font-weight: bold; margin-top: 1px; margin-bottom: 1px;">Установка дисплея или тачскрина заказчика</h2></td>
